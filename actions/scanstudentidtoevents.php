...
<input type="text" placeholder="<?php if($scannertype==3){echo "Enter Student ID (Including Zero)"; } else { echo "CLICK THIS BOX BEFORE EACH SCAN"; } ?>" style="display:block;margin:auto;text-align:center;width: <?php if($scannertype==3){echo '100'; } else { echo '800'; } ?>px;height:<?php if($scannertype==3){echo '30'; } else { echo '400'; } ?>px;" name="scanner" autofocus>
<br>
