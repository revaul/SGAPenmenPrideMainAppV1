...
<div id="about" class="container-fluid">
    ...
    <div class="col-sm-8">
    <h2>Penmen Pride Semester Change Over</h2>
<form action="actionsemchangeover.php" method="post">
<p><label>Current Semester:   </label>
<select name="host">
<?php 
...
$query = "SELECT semester.Semester FROM ppv0008003.semester where SemType!='Other';";
$results=mysqli_query($con, $query);

foreach ($results as $HostName){

?>
<option value="<?php echo $HostName["Semester"]; ?>"><?php echo $HostName["Semester"]; ?></option>
<?php
}
?>
</select></p>
